...
struct Constant {
    struct PointPowAPI {
        ...
        static let memberUpdateLastestAddress = "\(HOST)\(POINTPOW_VERSION1)member/address/set-status"
        ...
        static let updateCarts = "\(HOST)privilege/carts/update-with-stock"
        ...
        static let shipping_list = "\(HOST)\(POINTPOW_VERSION1)shipping-providers"
    }
